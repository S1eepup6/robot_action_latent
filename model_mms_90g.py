...
s1_pt_name = "/data/libero/exp_results/s1_mms_90g.pt".format(now, SEED)
s2_pt_name = "/data/libero/exp_results/s2_mms_90g.pt".format(now, SEED)
s3_pt_prefix = "/data/libero/exp_each/s3_mms_90g"
#################### ARGUMENTS #####################
