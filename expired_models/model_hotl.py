...
if __name__ == "__main__":
    ...
    if TRAIN:
        ...
        s1_pt_name = "/data/libero/exp_results/s1_hotl.pt".format(now, SEED)
        s2_pt_name = "/data/libero/exp_results/s2_hotl.pt".format(now, SEED)
        ...
        if STAGE == 3 or STAGE == 5:
            ...
            for task_id in range(22, 45): 
                print(task_id)
                s3_pt_name = "/data/libero/exp_each/s3_hotl_task_{}.pt".format(task_id)
                benchmark_dict = benchmark.get_benchmark_dict()
                task_suite = benchmark_dict['libero_90']()
                task = task_suite.get_task(task_id)
                task_name = task.name
