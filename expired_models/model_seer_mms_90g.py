...
s1_pt_name = "/data/libero/exp_results/s1_seer_mms_90g.pt".format(now, SEED)
s2_pt_prefix = "/data/libero/exp_each/s2_seer_mms_90g"
#################### ARGUMENTS #####################
...
if __name__ == "__main__":
    ...
    if TRAIN:
        ...
        for task_id in range(90): 
            ...
            task_name = task.name
            offline_data_dir = construct_task_data_path("/home/dls0901/data_prise/prise", task_name, TASK_DATA_DIR_SUFFIX)
