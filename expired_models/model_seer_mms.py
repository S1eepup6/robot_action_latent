...
s1_pt_name = "/data/libero/exp_results/s1g_seer_mms.pt".format(now, SEED)
s2_pt_prefix = "/data/libero/exp_each/s2g_seer_mms"
#################### ARGUMENTS #####################
...
class MYMODEL(nn.Module):
    def __init__(self,
        ...
        self.decoder = DECODER_MM(feature_dim=feature_dim//2, hidden_dim=hidden_dim, multi_modality=3, output_dim=action_dim).to(device)
