...
s1_pt_name = "/data/libero/exp_results/s1g_hotl_seer_mms.pt".format(now, SEED)
s2_pt_name = "/data/libero/exp_results/s2g_hotl_seer_mms.pt".format(now, SEED)
s3_pt_prefix = "/data/libero/exp_each/s3g_hotl_seer_mms"
#################### ARGUMENTS #####################
