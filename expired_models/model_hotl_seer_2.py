...
s1_pt_name = "/data/libero/exp_results/s1_hotl_seer_2.pt".format(now, SEED)
s2_pt_name = "/data/libero/exp_results/s2_hotl_seer_2.pt".format(now, SEED)
s3_pt_prefix = "/data/libero/exp_each/s3_hotl_seer_2"
#################### ARGUMENTS #####################
