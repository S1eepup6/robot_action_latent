...
RESULT_FILE_NAME = "performance_seer_mm_all.pkl"
AGENT_PATH_PREFIX = "/data/libero/exp_each/s2_seer_mm_all"
#################### ARGUMENTS #####################
    ...
    while eval_until_episode(episode):
        ...
        while step < EVAL_MAX_STEP:
            ...
            with torch.no_grad():
                ...
                if step % N_FUTURE == 0:
                    z_q, _, _ = agent.seer_module(history_obs_embed, history_obs_wrist, task_embedding)   
