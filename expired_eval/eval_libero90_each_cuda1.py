...
for i in tqdm(range(45)):
    ...
    agent_path = "/data/libero/exp_each/s3_hlpred_obs_task_{}.pt".format(i)
    print(agent_path)
    ...
    while eval_until_episode(episode):
        ...
        while step < EVAL_MAX_STEP:
            ...
            with torch.no_grad():
                ...
                action = agent.decoder(decoder_input)
    ...
    try:
        with open("performance_hlpred_obs.pkl", 'rb') as f:
            performance = pickle.load(f)
    except:
        performance = {}
    with open("performance_hlpred_obs.pkl", 'wb') as f:
