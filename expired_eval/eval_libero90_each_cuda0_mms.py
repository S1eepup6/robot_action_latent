...
RESULT_FILE_NAME = "performance_hotl_mms.pkl"
AGENT_PATH_PREFIX = "/data/libero/exp_each/s3_mms"
    ...
    while eval_until_episode(episode):
        ...
        while step < EVAL_MAX_STEP:
            ...
            with torch.no_grad():
                ...
                decoder_input = torch.concat([cur_obs, cur_wrist, cur_state, z_q], dim=1)
