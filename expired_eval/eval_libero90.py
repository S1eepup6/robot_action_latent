...
agent.load_state_dict(torch.load("/data/libero/exp_results/s3_06-11_22:20_0.pt"))
...
for i in tqdm(range(90)):
    ...
    try:
        with open("performance_4096.pkl", 'rb') as f:
            performance = pickle.load(f)
    except:
        performance = {}
    with open("performance_4096.pkl", 'wb') as f:
