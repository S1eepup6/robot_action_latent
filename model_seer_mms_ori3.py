...
from models.seer_encoder_ori import *
...
s1_pt_name = "/data/libero/exp_results/s1g_seer_mms_ori3.pt".format(now, SEED)
s2_pt_prefix = "/data/libero/exp_each/s2g_seer_mms_ori3"
#################### ARGUMENTS #####################
